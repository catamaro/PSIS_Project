...
client.o: Client/client.c Client/client.h Client/UI_library/UI_library.h
	gcc -c Client/client.c $(LFLAGS) $(LDLIBS)

server.o: Server/server.c Server/server.h Server/UI_library/UI_library.h
	gcc -c Server/server.c $(LFLAGS) $(LDLIBS)

UI_library.o: Client/UI_library/UI_library.c Client/UI_library/UI_library.h
	gcc -c Client/UI_library/UI_library.c $(LFLAGS) $(LDLIBS)
